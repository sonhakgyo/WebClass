...
<body>
    ...
    <form name="regform" id="regform" method="post" action="regist_ok.php" onsubmit="return sendit()">
        <input type="hidden" name="ischeckid" id="ischeckid" value="n">
        <input type="hidden" name="isssn" id="isssn" value="n">
        <p><label>아이디 : <input type="text" name="userid" id="userid" maxlength="20" onkeyup="idchange()"></label> <input type="button" value="중복확인" onclick="idcheck()"></p>
        <p id="idchecktext"></p>
        ...
        <p><label>주소 : <input type="text" id="sample6_address" name="address1"></label></p>
